...
6. After you get the ruselt you can use it to generate the ROC curve.(part of LMTID result are put in /image,such as ![vgg16_cifar10](./image/vgg16_cifar10.png)![DenseNet121_cifar10](./image/DenseNet121_cifar10e.png)
# Acknowledgements
